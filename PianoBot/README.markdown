...
3. Up-close pictures of the robot's "finger" can be found on my [Flickr page](http://www.flickr.com/photos/mattrajca/sets/72157624516153087/). The motor powering the "finger" should be connected to port A, while the other motors should be connected to ports B and C, respectively.
